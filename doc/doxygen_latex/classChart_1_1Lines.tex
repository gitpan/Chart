...
\begin{DoxyCompactList}\small\item\em finally get around to plotting the data for lines \item\end{DoxyCompactList}\item 
...
\hyperlink{classChart_1_1Bars}{Bars} class derived from class \hyperlink{classChart_1_1Base}{Base}. This class provides all functions which are specific to lines 

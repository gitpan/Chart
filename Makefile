...
# These definitions are from config.sh (via /usr/local/lib/perl5/5.6.0/alpha-dec_osf/Config.pm)

# They may have been overridden via Makefile.PL or on the command line
AR = ar
CC = cc
CCCDLFLAGS =  
CCDLFLAGS =   -Wl,-rpath,/usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE
DLEXT = so
DLSRC = dl_dlopen.xs
LD = ld
...
INSTALLARCHLIB = $(PREFIX)/lib/perl5/5.6.0/alpha-dec_osf
INSTALLSITELIB = $(PREFIX)/lib/perl5/site_perl/5.6.0
INSTALLSITEARCH = $(PREFIX)/lib/perl5/site_perl/5.6.0/alpha-dec_osf
INSTALLBIN = $(PREFIX)/bin
INSTALLSCRIPT = $(PREFIX)/scripts
PERL_LIB = /usr/local/lib/perl5/5.6.0
PERL_ARCHLIB = /usr/local/lib/perl5/5.6.0/alpha-dec_osf
...
PERLMAINCC = $(CC)
PERL_INC = /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE
...
INSTALLMAN3DIR = /usr/local/lib/perl5/5.6.0/man/man3
MAN3EXT = 3
PERM_RW = 644
PERM_RWX = 755
...
$(INST_AUTODIR)/.exists :: /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h
	@$(MKPATH) $(INST_AUTODIR)
	@$(EQUALIZE_TIMESTAMP) /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h $(INST_AUTODIR)/.exists

	-@$(CHMOD) $(PERM_RWX) $(INST_AUTODIR)

$(INST_LIBDIR)/.exists :: /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h
	@$(MKPATH) $(INST_LIBDIR)
	@$(EQUALIZE_TIMESTAMP) /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h $(INST_LIBDIR)/.exists

	-@$(CHMOD) $(PERM_RWX) $(INST_LIBDIR)

$(INST_ARCHAUTODIR)/.exists :: /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h
	@$(MKPATH) $(INST_ARCHAUTODIR)
	@$(EQUALIZE_TIMESTAMP) /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h $(INST_ARCHAUTODIR)/.exists
...
$(INST_MAN3DIR)/.exists :: /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h
	@$(MKPATH) $(INST_MAN3DIR)
	@$(EQUALIZE_TIMESTAMP) /usr/local/lib/perl5/5.6.0/alpha-dec_osf/CORE/perl.h $(INST_MAN3DIR)/.exists
...
POD2MAN_EXE = /usr/local/scripts/pod2man
...
manifypods : pure_all Chart.pod
	@$(POD2MAN) \
	Chart.pod \
	$(INST_MAN3DIR)/Chart.$(MAN3EXT)
